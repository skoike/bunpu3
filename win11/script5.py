...
for t in range(tm):
    ...
    #
    simulink=y.bunpu_simu_graph([[frpos1,flpos1,rlpos1,rrpos1,frpos2,flpos2,rlpos2,rrpos2],baria,baria2],simulink,t,tm,dlt0,'trace1',ptn=2,ratio=1, shape=[int(tm*7/10),int(tm*3/4)],fs=24)
